...
unwanted space when exporting org-mode to html."
      ...
      (defvar oucb-website-html-preamble
        "<div class='nav'>
<ul>
<li><a href='http://oucb.org'>博客</a></li>
<li><a href='/index.html'>Wiki目录</a></li>
</ul>
</div>")
      (defvar oucb-website-html-blog-head
        " <link rel='stylesheet' href='css/site.css' type='text/css'/> \n
    <link rel=\"stylesheet\" type=\"text/css\" href=\"/css/worg.css\"/>")
      (setq org-publish-project-alist
            `(
              ("blog-notes"
               :base-directory "~/OneDrive/org-notes"
               :base-extension "org"
               :publishing-directory "~/OneDrive/org-notes/public_html/"

               :recursive t
               :html-head , oucb-website-html-blog-head
               ...
               :section-numbers nil
               :html-preamble ,oucb-website-html-preamble
               :author "oucb"
               :email "oucb@outlook.com"
...
(defun oucb-org/init-org-mac-link ()
...
(defun oucb-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun oucb-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/OneDrive/org-notes")))

(defun oucb-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun oucb-org/post-init-deft ()
  (progn
